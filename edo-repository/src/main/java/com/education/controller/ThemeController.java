...
public class ThemeController {
    ...
    public ResponseEntity<ThemeDto> getThemeById(@PathVariable("id") Long id) {
        ...
        return new ResponseEntity<>(THEME_SERVICE.findById(id), THEME_SERVICE.findById(id) != null ? HttpStatus.OK : HttpStatus.NOT_FOUND);
    }
    ...
    public ResponseEntity<List<ThemeDto>> getAllById(@RequestParam(value = "ids", required = false) List<Long> ids) {
        ...
        return new ResponseEntity<>(THEME_SERVICE.findAllById(ids), HttpStatus.OK);
    }
    ...
    public ResponseEntity<ThemeDto> findByIdNotArchived(@PathVariable("id") Long id) {
        ...
        return new ResponseEntity<>(THEME_SERVICE.findByIdNotArchived(id), THEME_SERVICE.findByIdNotArchived(id) != null ? HttpStatus.OK : HttpStatus.NOT_FOUND);
    }
    ...
    public ResponseEntity<List<ThemeDto>> findAllByIdNotArchived(@RequestParam(value = "ids", required = false) List<Long> ids) {
        ...
        return new ResponseEntity<>(THEME_SERVICE.findAllByIdNotArchived(ids), HttpStatus.OK);
    }
    ...
    public ResponseEntity<Integer> moveToArchive(@PathVariable("id") Long id) {
        ...
        return new ResponseEntity<>(THEME_SERVICE.moveToArchive(id), HttpStatus.OK);
    }
}